...
const inputClass = 'h-[3.25rem] rounded-full border border-black/10 bg-[#f4f4f4] px-5 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-[var(--slot4-accent)] focus:bg-white'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-full bg-[var(--slot4-accent)] px-6 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:shadow-[0_18px_38px_rgba(53,199,183,0.32)] disabled:opacity-60'
